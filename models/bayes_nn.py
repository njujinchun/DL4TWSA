...
class BayesNN(nn.Module):
    ...
    def forward(self, input, hist):
        ...
        for i in range(self.n_samples):
            output.append(self.nnets[i].forward(input,hist))
    ...
    def _compute_mse_nlp(self, input, hist, target, size_average=True, out=False):
        ...
        output = self.forward(input,hist)
        # S x 1 x 1 x 1 x 1
    ...
    def predict(self, x_test,h_test):
        """
